...
def findAruco(img):
    ...
    if len(corners) > 0 :
       ...
       for(markerCorner,markerId) in zip(corners,ids):
           ...
           cropped_image = img[77:515, 78:515]
...
def crop(img):
    ...
    if len(corners) > 0 :
       ...
       for(markerCorner,markerId) in zip(corners,ids):
           ...
           cropped_image = img[79:515, 77:513]
           cv2.imshow("cropped",cropped_image)
           cv2.imwrite("HaHa_cropped.jpg",cropped_image)
           cv2.waitKey(0)
...
img3 = cv2.imread("D:\RONY\IIT Dhanbad\Atulya\My Project\HaHa.jpg")
